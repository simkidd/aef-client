            ...
            <div className="flex items-center gap-2 sm:gap-3">
              {user?.isStaff && (
                <Button
                  ...
                  className="gap-1.5 text-xs font-semibold text-teal-800 border-teal-200 bg-teal-50/50 hover:bg-teal-100 dark:bg-teal-950/40 dark:text-teal-300 hidden sm:flex"
                >
              ...
              <div className="flex items-center gap-2 pl-2">
                ...
                <div className="h-9 w-9 rounded-xl bg-linear-to-br from-teal-600 to-teal-800 text-white flex items-center justify-center font-bold text-xs shadow-xs">
                  {user?.firstName?.[0] || "B"}
                </div>
              </div>
            </div>
