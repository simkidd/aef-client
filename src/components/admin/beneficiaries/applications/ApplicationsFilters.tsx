...
const STATUS_OPTIONS = [
  ...
  { value: "Selected", label: "Selected (Queued for Verification & Biometrics)" },
  { value: "Pending Verification", label: "Pending Verification" },
  { value: "Biometric Registration", label: "Biometric Registration" },
  { value: "Enrollment Confirmed", label: "Enrollment Confirmed" },
  { value: "Assigned to Cohort", label: "Assigned to Cohort" },
    ...
    <Card className="p-4">
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 text-xs">
        ...
        <div className="relative w-full sm:w-xl">
          ...
          <Input
            placeholder="Search by candidate name, application number, phone..."
            value={search}
        ...
        <div className="w-full sm:w-72">
          ...
          >
            <SelectTrigger className="w-full h-9 min-h-9 data-[size=default]:h-9 text-xs">
              <SelectValue placeholder="All Lifecycle Statuses">
                {selectedStatusLabel}
              </SelectValue>
            </SelectTrigger>
            <SelectContent>
